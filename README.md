...
* 생성된 게시물은 바로 메인 페이지에 노출되며, 게시글 상세 페이지에서 수정 및 삭제를 할 수 있습니다.


<img src="https://user-images.githubusercontent.com/38210233/107745061-0e093980-6d57-11eb-80ef-f5b49bd32d2e.jpeg" width="35%">  <img src="https://user-images.githubusercontent.com/38210233/107936371-ea97f600-6fc5-11eb-8924-46742407587e.jpeg" width="35%">


* 추가적으로, 본 계정으로 생성한 게시물은 사이드 바에 있는 '내 게시물'에서 확인하실 수 있습니다.
...
* 생성된 키워드는 "알림 받을 키워드" 문구 아래에 차례로 추가됩니다.

<img src="https://user-images.githubusercontent.com/38210233/107936580-2af77400-6fc6-11eb-80d5-fe63a2db281f.jpeg" width="35%">  <img src="https://user-images.githubusercontent.com/38210233/107742568-9f29e180-6d52-11eb-85e8-87048a2838cc.jpeg" width="35%">
...
* 기존 계정으로 'A' 키워드를 생성한 후, 다른 아이디로 'A' 키워드를 포함한 제목의 게시물을 생성합니다.

(ex. test@test 계정으로 키워드 '노트북' 입력 후, test@2 계정에서 제목 '노트북' 이라는 게시물 생성. test@test 계정의 '노트북' 키워드 알림 확인가능)

(*자신이 올리는 게시글은 키워드 알림이 생성되지 않습니다.*)


* 게시글을 생성하면, 게시글 제목에 본인 키워드가 포함되는 유저들에게 키워드 알림이 생성됩니다.
